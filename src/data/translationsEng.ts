export const schoolTranslations: Record<string, string> = {
  ...
  '其它流派': 'Other Schools',
  '辩证/怀疑倾向': 'Dialectical / Skeptical Leaning',
  '折中主义 / 罗马哲理': 'Eclecticism / Roman Philosophy',
  '阿尔伯特-阿奎那派': 'Albertist-Thomist School',
  '空想社会主义': 'Utopian Socialism',
  '近代唯物主义': 'Modern Materialism',
  '科学史辩证': 'Dialectics of History of Science',
  '经验/主观唯心': 'Empirical / Subjective Idealism',
  '先驱/怀疑主义': 'Precursors / Skepticism',
  '温和启蒙学': 'Moderate Enlightenment',
  '激进启蒙学': 'Radical Enlightenment',
  '百科全书派': 'Encyclopedists',
  '战斗唯物主义': 'Combatant Materialism',
  '功利唯物派': 'Utilitarian Materialism',
  '战斗唯物机械系统': 'Combatant Materialism & Mechanical Systems',
  '古典批判哲学': 'Classical Critical Philosophy',
  '主观唯心主义': 'Subjective Idealism',
  '客观/同一唯心': 'Objective / Identity Idealism',
  '绝对唯心主义': 'Absolute Idealism',
  '人本主义唯物论': 'Humanistic Materialism',
...
export const conceptTranslations: Record<string, string> = {
  ...
  '三大批判': 'The Three Critiques',
  '认识论哥白尼革命': 'Copernican Revolution in Epistemology',
  '绝对命令': 'Categorical Imperative',
  '知识学基本原理': 'Foundations of the Science of Knowledge (Wissenschaftslehre)',
  '自我创生自我': 'The Ego Positing Itself',
  '“自我”对立于“非我”': 'The Ego Positing the Non-Ego',
  '自然哲学体系': 'System of Natural Philosophy',
  '绝对同一学说': 'Doctrine of Absolute Identity',
  '理智直观自我': 'Intellectual Intuition of the Self',
  '绝对精神大演进': 'Grand Evolution of the Absolute Spirit',
  '正反合辩证法': 'Thesis-Antithesis-Synthesis Dialectics',
  '实体即主体': 'Substance is Subject',
  '宗教本质异化说': 'Alienation of the Essence of Religion',
  '感性现实之人本体': 'Sensuous Reality of Human Ontology',
  '爱之宗教代替信之教条': 'Religion of Love Replacing Dogma of Faith',
  '意志乃世界唯一本体': 'Will as the Sole Ontology of the World',
  '世界是我的意志 and 表象': 'The World as Will and Representation',
  '世界是我的意志和表象': 'The World as Will and Representation',
  '欲望满足则无聊、不满足则痛苦': 'Satisfaction Leads to Boredom, Insatiety to Pain',
  '主观性就是真理': 'Subjectivity is Truth',
  '自由选择与面对空无的焦虑': 'Free Choice and Anxiety of Nothingness',
  '人生三阶段高度演生': 'Three Stages of Life Existential Pathway',
  '权力意志大高唱': 'Supreme Proclamation of the Will to Power',
  '重估一切价值': 'Revaluation of All Values',
  '上帝已死之钟声': 'The Death of God Tolls',
  '末人与超人': 'The Last Man and the Overman (Übermensch)',
  '实践性唯物主义': 'Practical Materialism',
  '唯物史观': 'Historical Materialism',
  '异化劳动与资本大解剖': 'Deconstruction of Alienated Labor & Capital',
  '共产主义必然胜利': 'The Inevitable Triumph of Communism',
  '数理逻辑奠基': 'Foundations of Mathematical Logic',
  '概念文字与涵义与指称说': 'Begriffsschrift & Sense and Reference',
  '反心理主义逻辑观': 'Anti-Psychologistic View of Logic',
  '摹状词理论': 'Theory of Descriptions',
  '罗素悖论与理发师比喻': 'Russell\'s Paradox & The Barber Paradox',
  '逻辑原子论说': 'Logical Atomism',
  '图像论：凡可说的说清楚': 'Picture Theory: What Can Be Said Must Be Said Clearly',
  '不可说的保持沉默': 'Whereof One Cannot Speak, Thereof One Must Be Silent',
  '游戏说：语言是一种生活形式': 'Language-Game: Language as a Form of Life',
  '经验论的两个教条': 'Two Dogmas of Empiricism',
  '本体论承诺': 'Ontological Commitment',
  '翻译的不确定性（翻译兔子例证）': 'Indeterminacy of Translation (Gavagai Example)',
  '回到事物本身！': 'Back to the Things Themselves!',
  '本质还原法与悬置（epoché）': 'Eidetic Reduction & Epoché (Suspension)',
  '意向性（Intentionality）': 'Intentionality',
  '此在（Dasein）与在世': 'Dasein & Being-in-the-world',
  '向死而生的绝命审视': 'Being-towards-death Examination',
  '存在与时间的交错': 'The Intertwining of Being and Time',
  '存在先于本质': 'Existence Precedes Essence',
  '人是被判定为自由的': 'Man is Condemned to be Free',
  '他人即地狱': 'Hell is Other People',
  '实用主义效果准则': 'Pragmatic Maxim of Effects',
  '信念的确定': 'The Fixation of Belief',
  '三分符号学大系统': 'Triadic Semiotic System',
  '真理的兑现价值说': 'The Cash Value of Truth',
  '彻底经验论': 'Radical Empiricism',
  '有用即真理的强权自救': 'Utility as Truth Self-Preservation',
  '工具主义：观念是行动工具': 'Instrumentalism: Ideas as Tools for Action',
  '教育即生活本身': 'Education is Life Itself',
  '经验与自然': 'Experience and Nature',
  '话语与权力（Power/Knowledge）': 'Discourse and Power (Power/Knowledge)',
  '全景敞视监视机器': 'The Panopticon Surveillance Machine',
  '人之死与谱系考古': 'The Death of Man & Archaeological Genealogy',
  '文本之外无他物': 'There is Nothing Outside the Text',
  '延异（Differance）': 'Différance',
  '击碎理性中心霸权': 'Deconstruction of Logocentrism',
  '哲学：自然之镜的彻底破碎': 'Philosophy: Breaking the Mirror of Nature',
  '后哲学文化': 'Post-Philosophical Culture',
  '自由主义铁人与反讽': 'Liberal Ironist & Solidarity',
};
