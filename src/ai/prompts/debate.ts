...
Ensure that all outputs are in strict, fluid English and conform EXACTLY to the requested JSON response schema.`
    : `你现在是雅典露天学园的大会主持法官。
...
Conform strictly to the JSON schema in fluent English.`
